...
func TestError(t *testing.T) {
	...
	if !strings.HasSuffix(strings.TrimSpace(out), "testutil/annotations_test.go,line=47:: - This is an error") {
...
func TestAnnotatedErrorf(t *testing.T) {
	...
	if !strings.HasSuffix(strings.TrimSpace(out), "testutil/annotations_test.go,line=62:: - This is a generic error") {
		t.Fatalf("unexpected stdout content: %s", out)
	}
}
