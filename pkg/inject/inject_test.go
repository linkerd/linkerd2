	...
	testCases := []struct {
	...
	}{
		{
				...
				Template: corev1.PodTemplateSpec{
					ObjectMeta: metav1.ObjectMeta{
						Annotations: map[string]string{
							...
							k8s.ProxyInboundHTTP1ConnectionPoolIdleTimeout:   "20000ms",
							k8s.ProxyOutboundHTTP1ConnectionPoolIdleTimeout:  "700s",
			...
			expected: func() *l5dcharts.Values {
				...
				values.Proxy.InboundHTTP1ConnectionPoolIdleTimeout = "20s"
				values.Proxy.OutboundHTTP1ConnectionPoolIdleTimeout = "700s"
		...
		},
		{
			...
			nsAnnotations: map[string]string{
				...
				k8s.ProxyInboundHTTP1ConnectionPoolIdleTimeout:  "30s",
				k8s.ProxyOutboundHTTP1ConnectionPoolIdleTimeout: "8000ms",
				k8s.ProxyDisableOutboundProtocolDetectTimeout:   "true",
			...
			expected: func() *l5dcharts.Values {
				...
				values.Proxy.InboundHTTP1ConnectionPoolIdleTimeout = "30s"
				values.Proxy.OutboundHTTP1ConnectionPoolIdleTimeout = "8s"
				values.Proxy.DisableOutboundProtocolDetectTimeout = true
		...
		},
		{
			...
			nsAnnotations: map[string]string{
				...
				k8s.ProxyInboundHTTP1ConnectionPoolIdleTimeout:  "30",
				k8s.ProxyOutboundHTTP1ConnectionPoolIdleTimeout: "700",
		...
		},
		{
			...
			nsAnnotations: map[string]string{
				...
				k8s.ProxyInboundHTTP1ConnectionPoolIdleTimeout:  "11s2000ms",
				k8s.ProxyOutboundHTTP1ConnectionPoolIdleTimeout: "11s2000ms",
			...
			expected: func() *l5dcharts.Values {
				...
				values.Proxy.InboundHTTP1ConnectionPoolIdleTimeout = "13s"
				values.Proxy.OutboundHTTP1ConnectionPoolIdleTimeout = "13s"
