...
const (
	...
	// ProxyRootParentVersionLabel is injected into mesh-enabled apps,
	// identifying the root owner version that this proxy belongs to.
	ProxyRootParentVersionLabel = Prefix + "/proxy-root-parent-version"
