...
* CLI
  ...
  * Added the `doc` command for generating docs for the CLI commands
  * Removed the "experimental" flag from auto-inject
  ...
  * Split the install templates by component
...
* Controller
  ...
  * Removed some proxy auto inject tests that were no longer relevant
