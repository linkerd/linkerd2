...
export const jaegerIcon = (
  <svg width="17px" height="17px" viewBox="-113.76 -96.84 64 64">
    <g transform="matrix(.38094 0 0 .38094 -67.511 -92.268)">
      ...
      <path d="M-29.32 14.167l-.472-1.623S-59.69.87-66.48 4.453-82.04 14.262-88.454 23.88l-.094 7.64s18.423 7.64 56.4-8.833c0 0-.503-4.592 2.83-8.52z" fill="#638b18" />
