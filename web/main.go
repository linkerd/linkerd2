...
func main() {
	...
	redirect := cmd.Bool("redirect", false, "enabling this redirects instead of proxying for grafana Url")
	...
	server := srv.NewServer(*addr, *grafanaAddr, *jaegerAddr, *redirect, *templateDir, *staticDir, uuid,
