...
func main() {
	...
	grafanaRedirect := cmd.Bool("grafana-redirect", false, "enabling this redirects instead of proxying for grafana Url")
	...
	server := srv.NewServer(*addr, *grafanaAddr, *jaegerAddr, *grafanaRedirect, *templateDir, *staticDir, uuid,
