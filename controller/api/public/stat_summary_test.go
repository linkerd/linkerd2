...
`,
				...
				expectedPrometheusQueries: []string{
					...
					`sum(increase(response_total{direction="outbound", dst_namespace="emojivoto", dst_pod="emojivoto-1"}[1m])) by (dst_namespace, dst_pod, conduit_io_control_plane_ns, dst_conduit_io_control_plane_ns)`,
				},
...
`,
				...
				expectedPrometheusQueries: []string{
					...
					`sum(increase(response_total{direction="outbound", namespace="emojivoto", pod="emojivoto-2"}[1m])) by (dst_namespace, dst_pod, conduit_io_control_plane_ns, dst_conduit_io_control_plane_ns)`,
				},
