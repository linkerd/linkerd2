...
type TlsVerification struct {
	...
	//	*TlsVerification_K8SPodNamespace_
...
type TlsVerification_K8SPodNamespace_ struct {
	K8SPodNamespace *TlsVerification_K8SPodNamespace `protobuf:"bytes,1,opt,name=k8s_pod_namespace,json=k8sPodNamespace,oneof"`
}

func (*TlsVerification_K8SPodNamespace_) isTlsVerification_Strategy() {}
...
func (m *TlsVerification) GetK8SPodNamespace() *TlsVerification_K8SPodNamespace {
	if x, ok := m.GetStrategy().(*TlsVerification_K8SPodNamespace_); ok {
...
func (*TlsVerification) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TlsVerification_OneofMarshaler, _TlsVerification_OneofUnmarshaler, _TlsVerification_OneofSizer, []interface{}{
		(*TlsVerification_K8SPodNamespace_)(nil),
	}
}
...
func _TlsVerification_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *TlsVerification_K8SPodNamespace_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
...
func _TlsVerification_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // strategy.k8s_pod_namespace
		...
		msg := new(TlsVerification_K8SPodNamespace)
		err := b.DecodeMessage(msg)
		m.Strategy = &TlsVerification_K8SPodNamespace_{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *TlsVerification_K8SPodNamespace) Reset()         { *m = TlsVerification_K8SPodNamespace{} }
func (m *TlsVerification_K8SPodNamespace) String() string { return proto.CompactTextString(m) }
func (*TlsVerification_K8SPodNamespace) ProtoMessage()    {}
func (*TlsVerification_K8SPodNamespace) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{4, 0}
}

func (m *TlsVerification_K8SPodNamespace) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *TlsVerification_K8SPodNamespace) GetPodName() string {
	if m != nil {
		return m.PodName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*TlsVerification_K8SPodNamespace)(nil), "conduit.proxy.destination.TlsVerification.K8sPodNamespace")
...
var fileDescriptor0 = []byte{
	...
	,
}
