...
type ApiErrors struct {
	Errors []*ApiError `protobuf:"bytes,1,rep,name=errors" json:"errors,omitempty"`
}

func (m *ApiErrors) Reset()                    { *m = ApiErrors{} }
func (m *ApiErrors) String() string            { return proto.CompactTextString(m) }
func (*ApiErrors) ProtoMessage()               {}
func (*ApiErrors) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *ApiErrors) GetErrors() []*ApiError {
	if m != nil {
		return m.Errors
	}
	return nil
...
type StatTable_PodGroup_Row struct {
	...
	ErrorsByPod map[string]*ApiErrors `protobuf:"bytes,7,rep,name=errors_by_pod,json=errorsByPod" json:"errors_by_pod,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *StatTable_PodGroup_Row) GetErrorsByPod() map[string]*ApiErrors {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ApiErrors)(nil), "conduit.public.ApiErrors")
