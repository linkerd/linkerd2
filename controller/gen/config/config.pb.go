...
type Global struct {
	...
	TlsManager           string   `protobuf:"bytes,9,opt,name=tlsManager,proto3" json:"tlsManager,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Global) GetTlsManager() string {
	if m != nil {
		return m.TlsManager
	}
	return ""
...
var fileDescriptor_cc332a44e926b360 = []byte{
	...
	,
}
