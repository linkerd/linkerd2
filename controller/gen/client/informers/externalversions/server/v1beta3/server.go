...
import (
	...
	v1beta3 "github.com/linkerd/linkerd2/controller/gen/client/listers/server/v1beta3"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServerV1beta3().Servers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServerV1beta3().Servers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&serverv1beta3.Server{}, f.defaultInformer)
}

func (f *serverInformer) Lister() v1beta3.ServerLister {
	return v1beta3.NewServerLister(f.Informer().GetIndexer())
}
