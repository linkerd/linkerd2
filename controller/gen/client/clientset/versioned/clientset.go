...
import (
	...
	policyv1alpha3 "github.com/linkerd/linkerd2/controller/gen/client/clientset/versioned/typed/policy/v1alpha3"
...
type Interface interface {
	...
	PolicyV1alpha3() policyv1alpha3.PolicyV1alpha3Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	policyV1alpha3             *policyv1alpha3.PolicyV1alpha3Client
...
// PolicyV1alpha3 retrieves the PolicyV1alpha3Client
func (c *Clientset) PolicyV1alpha3() policyv1alpha3.PolicyV1alpha3Interface {
	return c.policyV1alpha3
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.policyV1alpha3, err = policyv1alpha3.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.policyV1alpha3 = policyv1alpha3.New(c)
