...
var linksResource = v1alpha2.SchemeGroupVersion.WithResource("links")

var linksKind = v1alpha2.SchemeGroupVersion.WithKind("Link")

// Get takes name of the link, and returns the corresponding link object, and an error if there is any.
func (c *FakeLinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Link, err error) {
	emptyResult := &v1alpha2.Link{}
	obj, err := c.Fake.
...
func (c *FakeLinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.LinkList, err error) {
	emptyResult := &v1alpha2.LinkList{}
	obj, err := c.Fake.
...
func (c *FakeLinks) Create(ctx context.Context, link *v1alpha2.Link, opts v1.CreateOptions) (result *v1alpha2.Link, err error) {
	emptyResult := &v1alpha2.Link{}
	obj, err := c.Fake.
...
func (c *FakeLinks) Update(ctx context.Context, link *v1alpha2.Link, opts v1.UpdateOptions) (result *v1alpha2.Link, err error) {
	emptyResult := &v1alpha2.Link{}
	obj, err := c.Fake.
...
func (c *FakeLinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(linksResource, c.ns, name, opts), &v1alpha2.Link{})
...
func (c *FakeLinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Link, err error) {
	emptyResult := &v1alpha2.Link{}
	obj, err := c.Fake.
