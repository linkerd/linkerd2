...
func (c *servers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta3.Server, err error) {
	result = &v1beta3.Server{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servers").
		Name(name).
...
func (c *servers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta3.ServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta3.ServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servers").
...
func (c *servers) Create(ctx context.Context, server *v1beta3.Server, opts v1.CreateOptions) (result *v1beta3.Server, err error) {
	result = &v1beta3.Server{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servers").
...
func (c *servers) Update(ctx context.Context, server *v1beta3.Server, opts v1.UpdateOptions) (result *v1beta3.Server, err error) {
	result = &v1beta3.Server{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servers").
...
func (c *servers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.Server, err error) {
	result = &v1beta3.Server{}
