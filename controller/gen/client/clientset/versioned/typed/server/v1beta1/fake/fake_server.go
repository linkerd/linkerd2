...
var serversResource = schema.GroupVersionResource{Group: "server.linkerd.io", Version: "v1beta1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "server.linkerd.io", Version: "v1beta1", Kind: "Server"}
...
func (c *FakeServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(serversResource, c.ns, name), &v1beta1.Server{})
