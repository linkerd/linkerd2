...
var serverauthorizationsResource = schema.GroupVersionResource{Group: "serverauthorization.linkerd.io", Version: "v1beta1", Resource: "serverauthorizations"}

var serverauthorizationsKind = schema.GroupVersionKind{Group: "serverauthorization.linkerd.io", Version: "v1beta1", Kind: "ServerAuthorization"}
...
func (c *FakeServerAuthorizations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(serverauthorizationsResource, c.ns, name), &v1beta1.ServerAuthorization{})
