...
type HTTPRouteInterface interface {
	Create(ctx context.Context, hTTPRoute *v1alpha3.HTTPRoute, opts v1.CreateOptions) (*v1alpha3.HTTPRoute, error)
	Update(ctx context.Context, hTTPRoute *v1alpha3.HTTPRoute, opts v1.UpdateOptions) (*v1alpha3.HTTPRoute, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.HTTPRoute, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.HTTPRouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.HTTPRoute, err error)
	HTTPRouteExpansion
}
...
func newHTTPRoutes(c *PolicyV1alpha3Client, namespace string) *hTTPRoutes {
	return &hTTPRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *hTTPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.HTTPRoute, err error) {
	result = &v1alpha3.HTTPRoute{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httproutes").
		Name(name).
...
func (c *hTTPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.HTTPRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.HTTPRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) Create(ctx context.Context, hTTPRoute *v1alpha3.HTTPRoute, opts v1.CreateOptions) (result *v1alpha3.HTTPRoute, err error) {
	result = &v1alpha3.HTTPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) Update(ctx context.Context, hTTPRoute *v1alpha3.HTTPRoute, opts v1.UpdateOptions) (result *v1alpha3.HTTPRoute, err error) {
	result = &v1alpha3.HTTPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httproutes").
...
func (c *hTTPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.HTTPRoute, err error) {
	result = &v1alpha3.HTTPRoute{}
