...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrustRootsStatus) DeepCopyInto(out *TrustRootsStatus) {
	*out = *in
	if in.TargetClusterTrustMetadata != nil {
		in, out := &in.TargetClusterTrustMetadata, &out.TargetClusterTrustMetadata
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrustRootsStatus.
func (in *TrustRootsStatus) DeepCopy() *TrustRootsStatus {
	if in == nil {
		return nil
	}
	out := new(TrustRootsStatus)
