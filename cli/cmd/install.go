...
func (options *installOptions) recordFlags(flags *pflag.FlagSet) {
	...
	flags.VisitAll(func(f *pflag.Flag) {
		if f.Changed {
			switch f.Name {
			case "ignore-cluster", "control-plane-version", "proxy-version", "identity-issuer-certificate-file", "identity-issuer-key-file":
...
// VerifyCreds verifies the validity of the provided certs
