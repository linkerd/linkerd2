...
func testRenderHelm(t *testing.T, chart *pb.Chart, goldenFileName string) {
  ...
  "gatewayAnnotator":{
    "keyPEM":"test-gateway-annotator-key-pem",
    "crtPEM":"test-gateway-annotator-crt-pem"
  },
  "tap":{
