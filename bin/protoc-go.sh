...
"$bindir"/protoc -I proto -I viz/metrics-api/proto --go-grpc_out=paths=source_relative:viz/metrics-api/gen viz/metrics-api/proto/viz.proto
...
"$bindir"/protoc -I proto -I viz/tap/proto -I viz/metrics-api/proto --go-grpc_out=paths=source_relative:viz/tap/gen viz/tap/proto/viz_tap.proto
...
mv viz/metrics-api/gen/viz_grpc.pb.go viz/metrics-api/gen/viz/viz_grpc.pb.go
mv viz/tap/gen/viz_tap.pb.go viz/tap/gen/tap/viz_tap.pb.go
mv viz/tap/gen/viz_tap_grpc.pb.go viz/tap/gen/tap/viz_tap_grpc.pb.go
