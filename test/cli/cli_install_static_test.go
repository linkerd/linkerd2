...
func TestMain(m *testing.M) {
	...
	TestHelper = testutil.NewGenericTestHelper(*linkerd, "", "l5d", "linkerd-viz", "", "", "", "", "", "", "", "", false, false, false, false, false, true, false, *http.DefaultClient, testutil.KubernetesHelper{})
	os.Exit(m.Run())
}
