...
///
/// This isn't _directly_ related to task execution, but the functionality
/// is similar to that of `LazyExecutor`, so it lives here until there's
/// a more reasonable place to put it.
#[derive(Copy, Clone, Debug, Default)]
pub struct LazyRng;
