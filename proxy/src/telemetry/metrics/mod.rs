        ...
        match *event {
            ...
            Event::StreamResponseEnd(ref res, ref end) => {
                ...
                self.update(|metrics| {
                    ...
                    metrics.response_latency(&labels).add(end.since_request_open.into());
                });
            },
            ...
            Event::StreamResponseFail(ref res, ref fail) => {
                ...
                self.update(|metrics| {
                    metrics.response_total(&labels).incr();
                    metrics.response_latency(&labels).add(fail.since_request_open.into());
                });
            },
            ...
            Event::TransportClose(ref ctx, ref close) => {
                ...
                self.update(|metrics| {
                    ...
                    *metrics.tcp().read_bytes_total(&labels) += close.rx_bytes as u64;
                    ...
                    metrics.tcp().connection_duration(&close_labels).add(close.duration.into());
