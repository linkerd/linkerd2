...
build_architecture
  digraph G {
    ...
    "integration_tests.yml" -> "docker-build-proxy";
    "integration_tests.yml" -> "docker-build-controller";
    "integration_tests.yml" -> "docker-build-metrics-api";
    "integration_tests.yml" -> "docker-build-web";
    "integration_tests.yml" -> "docker-build-cni-plugin";
    "integration_tests.yml" -> "docker-build-debug";
    "integration_tests.yml" -> "docker-build-cli-bin";
    "integration_tests.yml" -> "docker-build-grafana";
    "integration_tests.yml" -> "docker-build-jaeger-webhook";
    "integration_tests.yml" -> "docker-build-tap";
    "integration_tests.yml" -> "docker-cache-prune";

    "release.yml" -> "_tag.sh";
    "release.yml" -> "_docker.sh";
    "release.yml" -> "_release.sh";
    "release.yml" -> "docker-build-proxy";
    "release.yml" -> "docker-build-controller";
    "release.yml" -> "docker-build-metrics-api";
    "release.yml" -> "docker-build-web";
