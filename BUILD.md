...
build_architecture
  digraph G {
    ...
    "viz/metrics-api/Dockerfile" [color=lightblue, style=filled, shape=rect];
    "viz/tap/Dockerfile" [color=lightblue, style=filled, shape=rect];
    "grafana/Dockerfile" [color=lightblue, style=filled, shape=rect];
    "jaeger/injector/Dockerfile" [color=lightblue, style=filled, shape=rect];

    "_docker.sh" -> "_log.sh";

    "build-cli-bin" -> "_tag.sh";
    "build-cli-bin" -> "_os.sh";
    ...
    "docker-build" -> "docker-build-metrics-api";
    "docker-build" -> "docker-build-tap";
    "docker-build" -> "docker-build-grafana";
    "docker-build" -> "docker-build-jaeger-webhook";
    ...
    "docker-build-metrics-api" -> "_docker.sh";
    "docker-build-metrics-api" -> "_tag.sh";
    "docker-build-metrics-api" -> "viz/metrics-api/Dockerfile";

    "docker-build-tap" -> "_docker.sh";
    "docker-build-tap" -> "_tag.sh";
    "docker-build-tap" -> "viz/tap/Dockerfile";
    ...
    "docker-pull-binaries" -> "_docker.sh";
    ...
    "helm-build" -> "_tag.sh";
    "helm-docs";
    "helm-docs-diff" -> "helm-docs";

    "image-load" -> "_docker.sh";
    "image-load" -> "_tag.sh";
    ...
    "static_checks.yml" -> "lint";
    "static_checks.yml" -> "fmt";
    "static_checks.yml" -> "protoc-diff";
    "static_checks.yml" -> "shellcheck-all";
    "static_checks.yml" -> "markdownlint-all";
    "static_checks.yml" -> "helm-docs-diff";

    "unit_tests.yml" -> "web"

    "integration_tests.yml" -> "_tag.sh";
    "integration_tests.yml" -> "_docker.sh";
    "integration_tests.yml" -> "docker-build-proxy.sh";
    "integration_tests.yml" -> "docker-build-controller.sh";
    "integration_tests.yml" -> "docker-build-metrics-api.sh";
    "integration_tests.yml" -> "docker-build-web.sh";
    "integration_tests.yml" -> "docker-build-cni-plugin.sh";
    "integration_tests.yml" -> "docker-build-debug.sh";
    "integration_tests.yml" -> "docker-build-cli-bin.sh";
    "integration_tests.yml" -> "docker-build-grafana.sh";
    "integration_tests.yml" -> "docker-build-jaeger-webhook.sh";
    "integration_tests.yml" -> "docker-build-tap.sh";
    "integration_tests.yml" -> "docker-cache-prune";

    "release.yml" -> "_tag.sh";
    "release.yml" -> "_docker.sh";
    "release.yml" -> "_release.sh";
    "release.yml" -> "docker-build-proxy.sh";
    "release.yml" -> "docker-build-controller.sh";
    "release.yml" -> "docker-build-metrics-api.sh";
    "release.yml" -> "docker-build-web.sh";
    "release.yml" -> "docker-build-cni-plugin.sh";
    "release.yml" -> "docker-build-debug.sh";
    "release.yml" -> "docker-build-cli-bin.sh";
    "release.yml" -> "docker-build-grafana.sh";
    "release.yml" -> "docker-build-jaeger-webhook.sh";
    "release.yml" -> "docker-build-tap.sh";
    "release.yml" -> "docker-cache-prune";
    "release.yml" -> "docker-pull-binaries";
    "release.yml" -> "test-cleanup";
    "release.yml" -> "helm-build";
  }
build_architecture
</details>
<!-- markdownlint-enable no-inline-html -->
