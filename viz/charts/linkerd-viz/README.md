...
![Version: 30.14.10-edge](https://img.shields.io/badge/Version-30.14.10--edge-informational?style=flat-square)
...
| prometheusAuthCreds | string | `""` | Prometheus authentication credentials |
| prometheusAuthType | string | `""` | Prometheus authentication type. Possible values: basic | bearer |
