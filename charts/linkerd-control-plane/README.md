...
| networkValidator.logFormat | string | plain | Log format (`plain` or `json`) for the proxy-init |
| networkValidator.logLevel | string | info | Log level for the network-validator |
