...
| `global.linkerdVersion`                      | Control plane version                                                                                                                                                                 | latest stable version                |
...
| `global.proxy.image.version`                 | Tag for the proxy container Docker image                                                                                                                                              | latest stable version                |
