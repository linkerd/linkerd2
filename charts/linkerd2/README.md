...
| identity.externalCA | bool | `false` | If the linkerd-identity-trust-roots ConfigMap/Secret has already been created |
| identity.externalCAFromSecret | bool | `false` | If the linkerd-identity-trust-roots should be pulled from a Secret instead of a ConfigMap |
