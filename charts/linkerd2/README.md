...
| controlPlaneTracing | bool | `false` | control plane trace configuration |
...
| proxy.trace.collectorSvcAccount | string | `"default"` | Service account associated with the Trace collector instance  |
| proxy.trace.collectorSvcAddr | string | `""` | Collector Service address for the proxies to send Trace Data  |
