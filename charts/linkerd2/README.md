...
| `controller.deployment.annotations`         | Additional annotations on controller deployment                                                                                                                                       | `{}`                                 |
| `controller.deployment.labels`              | Additional labels on controller deployment                                                                                                                                            | `{}`                                 |
| `controller.service.annotations`            | Additional annotations on controller service                                                                                                                                          | `{}`                                 |
| `controller.service.labels`                 | Additional labels on controller service                                                                                                                                               | `{}`                                 |
| `dashboard.deployment.annotations`          | Additional annotations on dashboard deployment                                                                                                                                        | `{}`                                 |
| `dashboard.deployment.labels`               | Additional labels on dashboard deployment                                                                                                                                             | `{}`                                 |
| `dashboard.replicas`                        | Number of replicas of dashboard                                                                                                                                                       | `1`                                  |
| `dashboard.service.annotations`             | Additional annotations on dashboard service                                                                                                                                           | `{}`                                 |
| `dashboard.service.labels`                  | Additional labels on dashboard service                                                                                                                                                | `{}`                                 |
...
| `destination.deployment.annotations`        | Additional annotations on destination deployment                                                                                                                                      | `{}`                                 |
| `destination.deployment.labels`             | Additional labels on destination deployment                                                                                                                                           | `{}`                                 |
| `destination.service.annotations`           | Additional annotations on destination service                                                                                                                                         | `{}`                                 |
| `destination.service.labels`                | Additional labels on destination service                                                                                                                                              | `{}`                                 |
...
| `identity.deployment.annotations`           | Additional annotations on identity deployment                                                                                                                                         | `{}`                                 |
| `identity.deployment.labels`                | Additional labels on identity deployment                                                                                                                                              | `{}`                                 |
...
| `identity.service.annotations`              | Additional annotations on identity service                                                                                                                                            | `{}`                                 |
| `identity.service.labels`                   | Additional labels on identity service                                                                                                                                                 | `{}`                                 |
...
| `prometheus.deployment.annotations`         | Additional annotations on prometheus deployment                                                                                                                                       | `{}`                                 |
| `prometheus.deployment.labels`              | Additional labels on prometheus deployment                                                                                                                                            | `{}`                                 |
| `prometheus.service.annotations`            | Additional annotations on prometheus service                                                                                                                                          | `{}`                                 |
| `prometheus.service.labels`                 | Additional labels on prometheus service                                                                                                                                               | `{}`                                 |
...
| `proxyInjector.deployment.annotations`      | Additional annotations on proxyInjector deployment                                                                                                                                    | `{}`                                 |
| `proxyInjector.deployment.labels`           | Additional labels on proxyInjector deployment                                                                                                                                         | `{}`                                 |
| `proxyInjector.service.annotations`         | Additional annotations on proxyInjector service                                                                                                                                       | `{}`                                 |
| `proxyInjector.service.labels`              | Additional labels on proxyInjector service                                                                                                                                            | `{}`                                 |
...
| `profileValidator.deployment.annotations`   | Additional annotations on profileValidator deployment                                                                                                                                 | `{}`                                 |
| `profileValidator.deployment.labels`        | Additional labels on profileValidator deployment                                                                                                                                      | `{}`                                 |
| `profileValidator.service.annotations`      | Additional annotations on profileValidator service                                                                                                                                    | `{}`                                 |
| `profileValidator.service.labels`           | Additional labels on profileValidator service                                                                                                                                         | `{}`                                 |
| `smiMetrics.deployment.annotations`         | Additional annotations on smiMetrics deployment                                                                                                                                       | `{}`                                 |
| `smiMetrics.deployment.labels`              | Additional labels on smiMetrics deployment                                                                                                                                            | `{}`                                 |
| `smiMetrics.service.annotations`            | Additional annotations on smiMetrics service                                                                                                                                          | `{}`                                 |
| `smiMetrics.service.labels`                 | Additional labels on smiMetrics service                                                                                                                                               | `{}`                                 |
...
| `tap.deployment.annotations`                | Additional annotations on tap deployment                                                                                                                                              | `{}`                                 |
| `tap.deployment.labels`                     | Additional labels on tap deployment                                                                                                                                                   | `{}`                                 |
| `tap.service.annotations`                   | Additional annotations on tap service                                                                                                                                                 | `{}`                                 |
| `tap.service.labels`                        | Additional labels on tap service                                                                                                                                                      | `{}`                                 |
