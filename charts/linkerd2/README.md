...
| `controllerResources`                   | CPU and Memory resources requested for controller (see `global.proxy.resources` for sub-fields)             |   |
| `controllerProxyResources`              | CPU and Memory resources requested for proxy injected into controller pod (see `global.proxy.resources` for sub-fields)             |  values  `global.proxy.resources`   |
...
| `destinationResources`                   | CPU and Memory resources requested for destination (see `global.proxy.resources` for sub-fields)             |   |
| `destinationProxyResources`              | CPU and Memory resources requested for proxy injected into destination pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
| 'Resources'                   | CPU and Memory resources requested for (see `global.proxy.resources` for sub-fields)             |   |
| 'ProxyResources'              | CPU and Memory resources requested for proxy injected into  pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
...
| grafanaResources                   | CPU and Memory resources requested for grafana (see `global.proxy.resources` for sub-fields)             |   |
| grafanaProxyResources              | CPU and Memory resources requested for proxy injected into grafana pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
...
| prometheusResources                   | CPU and Memory resources requested for prometheus (see `global.proxy.resources` for sub-fields)             |   |
| prometheusProxyResources              | CPU and Memory resources requested for proxy injected into prometheus pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
| `proxyInjectorResources`                   | CPU and Memory resources requested for the proxy injector (see `global.proxy.resources` for sub-fields)             |   |
| `proxyInjectorProxyResources`              | CPU and Memory resources requested for proxy injected into the proxy injector pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
...
| `tapResources`                   | CPU and Memory resources requested for tap (see `global.proxy.resources` for sub-fields)             |   |
| `tapProxyResources`              | CPU and Memory resources requested for proxy injected into tap pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
...
| `webResources`                   | CPU and Memory resources requested for web UI (see `global.proxy.resources` for sub-fields)             |   |
| `webProxyResources`              | CPU and Memory resources requested for proxy injected into web UI pod (see `global.proxy.resources` for sub-fields)             | values in `global.proxy.resources`   |
