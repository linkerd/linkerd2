...
| `controllerResources`                   | CPU and Memory resources required by controller (see `global.proxy.resources` for sub-fields)             |   |
| `controllerProxyResources`              | CPU and Memory resources required by proxy injected into controller pod (see `global.proxy.resources` for sub-fields)             |  values  `global.proxy.resources`   |
