...
| `proxyInjector.externalSecret`              | Do not create a secret resource for the profileValidator webhook. Default is false (i.e. create the secret). If this is set to `true`, the value `proxyInjector.caBundle` muste be set (see below).                               |                                      |
...
| `profileValidator.externalSecret`           | Do not create a secret resource for the profileValidator webhook. Default is false (i.e. create the secret). If this is set to `true`, the value `profileValidator.caBundle` muste be set (see below).                            |                                       |
...
| `smiMetrics.externalSecret`                 | Do not create a secret resource for the SMI metrics component. Default is false (i.e. create the secret). If this is set to `true`, the value `smiMetrics.caBundle` muste be set (see below).||
| `smiMetrics.image`                          | The image and tag to use for the SMI metrics component. Defaults to `deislabs/smi-metrics:v0.2.1`
...
| `tap.externalSecret`                        | Do not create a secret resource for the Tap component. Default is false (i.e. create the secret). If this is set to `true`, the value `tap.caBundle` muste be set (see below).                            |                                       |
