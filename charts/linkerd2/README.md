...
|:--------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------|
| `controllerImage`                           | Docker image for the controller, tap and identity components                                                                                                                          | `cr.l5d.io/linkerd/controller`       |
...
| `debugContainer.image.name`                 | Docker image for the debug container                                                                                                                                                  | `cr.l5d.io/linkerd/debug`            |
...
| `global.proxy.image.name`                   | Docker image for the proxy                                                                                                                                                            | `cr.l5d.io/linkerd/proxy`            |
...
| `global.proxyInit.image.name`               | Docker image for the proxy-init container                                                                                                                                             | `cr.l5d.io/linkerd/proxy-init`       |
...
| `webImage`                                  | Docker image for the web container                                                                                                                                                    | `cr.l5d.io/linkerd/web`              |
...
| `grafana.image.name`                | Docker image name for the grafana instance                                                                                                                                                 | `cr.l5d.io/linkerd/grafana`                             |
