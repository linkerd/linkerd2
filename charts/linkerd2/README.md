...
| `proxyInjector.configAnnotations`           | Annotations to add to the proxy injector `MutatingWebhookConfiguration` resource. This may be used e.g. for configuring cert-manager to automatically inject the CA cert bundle | |
...
| `profileValidator.configAnnotations`        | Annotations to add to the profile validator `ValidatingWebhookConfiguration` resource. This may be used e.g. for configuring cert-manager to automatically inject the CA cert bundle | |
...
| `tap.configAnnotations`        | Annotations to add to the tap `APIService` resource. This may be used e.g. for configuring cert-manager to automatically inject the CA cert bundle | |
